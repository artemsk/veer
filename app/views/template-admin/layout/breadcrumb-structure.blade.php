<ol class="breadcrumb">
	...
	@endif
	@if((isset($items['filtered']) && $place == "categories") || $place == "category") 
	...
	@endif	
	@if((isset($items['filtered']) && $place == "pages") || $place == "page") 
	...
	@endif
	@if((isset($items['filtered']) && $place == "products") || $place == "product") 
