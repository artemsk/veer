...
<div class="container">
	<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
		...
		<div class="panel panel-default @if($item->pin == true) pinned @endif">
			<div class="panel-heading" role="tab" data-toggle="collapse" data-target="#collapse{{ $key }}" data-parent="#accordion">
				...
				<small>#{{ $item->id }}</small>
				<span class="label label-yellow label-bg">ID {{ app('veershop')->getOrderId($item->cluster, $item->cluster_oid) }}</span>
