...
<html>
  <head>
    ...
    <title>{{ empty($title) ? db_parameter('SITE_TITLE') : $title }} — {{ db_parameter('SITE_MOTO') }}</title>
  ...
  <body>
	...
	{{ empty($veer_message_center) ?: $veer_message_center }}
    ...
    <script src="{{ URL::asset('assets/'.$template.'/js/shop.js') }}"></script>
  </body>
</html>