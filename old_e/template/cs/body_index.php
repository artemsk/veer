     <div class="head-logo"><img src="{TEMPL_PATH}/img/logo12.png" class="img-responsive"></div>
    ...
    <div class="rowdelimiter-small"></div>
     ...
     <div class="row">
         <div class="col-sm-6">
             ...
             <div class="block-big">
                 <div class="big-img"><a href="{MP_0_NAZVLNK}"><img src="{MP_0_IMGFULL}" class="img-responsive img-center"></a></div> 
                 <div class="block-stndrt-footer"><a href="{MP_0_CATLNK}">{MP_0_CAT}</a></div>
                 <h3><a href="{MP_0_NAZVLNK}">{MP_0_NAZV}</a></h3>
                 <h5>{MP_0_PRICE}</h5>
                 <div class="basket">{MP_0_BASKET}</div>              
             </div>
             
             <div class="rowdelimiter-small"></div>
             
             <div class="block-stndrt">
                 <div class="cs-thumbnail-img"><a href="{MP_3_NAZVLNK}"><img src="{MP_3_IMG}" class="img-responsive img-responsive-custom" ></a></div>
                 <div class="block-stndrt-footer"><a href="{MP_3_CATLNK}">{MP_3_CAT}</a></div>
                 <h4><a href="{MP_3_NAZVLNK}">{MP_3_NAZV}</a></h4>
                 <h5>{MP_3_PRICE}</h5>
                 <div class="basket">{MP_3_BASKET}</div>                 
             </div>
