...
class categories {
    ...
    function show_tree($i = SHOP_NNN, $curr = "", $search = "") { // ������ ��� ����� �������; $ret=full, simple
        Debug::log();
        // ���������� ���, ���� �� ������ ��������� �������
    ...
    function gather($i = SHOP_NNN, $gather_type = "brief") { // gather_type - brief(��� ������ ��� ��� ��������), full(��� ������)
        Debug::log();
...
class attribs {
    ...
    // TODO: ��� ������ �������� ���������� ������� ������� � ������� �� ��������
    function gather($what = "all", $shop_cat = SHOP_NNN, $limit = "") { // all - ��� ������������ �������� ��� ��� �������� ���������� ��������
        Debug::log();
...
class keyws {
    ...
    function gather($shop_cat = SHOP_NNN, $limit = "10") { // all - ��� ������������ ���� �����
        Debug::log();
        $add_sql = cats("sql", $shop_cat);
        $limit_s = $limit;
        if ($limit <= 0) {
...
class ratings {
    ...
    function recomend($c_id = "0", $type = "visits", $limit = "10", $prd_one_flag = "") { // visits!, keywords! orders, search, random?
        ...
        // ������������: VISITS
        if ($prd_one_flag == "" && $type == "visits") { // TODO: ������ !visits ����� �� ���� ������� ������� � ��
    ...
    function pop($type = "views", $sort = "month", $limit = "10") {
        Debug::log();
        //// ���������� ������: ��������� views, ������ orders, ���������� reviews ��� ������ random
        // sort - month, day
        $limit = LIMIT_PRD_POP + $limit;
        $months = array("01" => "������", "02" => "�������", "03" => "�����", "04" => "������", "05" => "���", "06" => "����", "07" => "����", "08" => "�������",
            "09" => "��������", "10" => "�������", "11" => "������", "12" => "�������");

        $txt = array("viewed_month" => "���������� ������ ������", "viewed_day" => "���������� ������ �������",
    ...
    function random($type = "random", $limit = "1", $nnn = "") { // ������ ������
        ...
        if ($type == "keyword") {
            ...
            if ($keyws4_kwrd != "") {
                $zag = "�������� ����� &rarr; <strong>" . $keyws4_kwrd . "</strong>";
    ...
    function recomend_cats($c_id = "0", $limit = LIMIT_POP_CAT, $every_customer = "") { // everycustomer - ���������� ������� � ��������
        Debug::log();
        // TODO: ������ �������� ���� ������
        /*
          //// ������������� ��� ���������� �������
          ...
          if($c_id<=0) { return array("lst"=>$s3['/catalog/'],"zag"=>POPULAR_CATS_NAME); break; } // ���� ��� �������, �� ������ ���������� ���������� �������
          ...
          if(count($s7)<$limit) { $s7=@array_merge(@$s7,@$s3['/catalog/']); $s7=@array_combine(@$s7, @$s7); } // �������� �����������
