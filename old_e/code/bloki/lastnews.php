...
//$out["{LAST_ARTICLES}"]="";
  ...
  if(@$flag_got_last_articles_from_file=="1"&&@$flag_got_news_from_file=="1") {} else {
        ...
        if($url=="") {
           ...
           $news_list=$ppp->show_pages($url_val_tmp, "last",CATPAGE_ARTICLES_LIMIT); } // ��� ��������� �������� ������ ��������� ������
        }

        $n4=0;

        if($url==""&&@$flag_got_news_from_file!="1") { $news_arr=$ppp->prepare_news($news_list[1]); } // ������ �� �������

        if(count($news_list[0])>0&&@$flag_got_last_articles_from_file!="1") { $n5="";
         foreach($news_list[0] as $n1=>$n2) { // ������ ������
